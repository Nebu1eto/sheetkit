...
- `index.js` -- ESM wrapper that loads `binding.cjs` via `createRequire`. This file is checked into the repository and must not be overwritten by the napi build output.
